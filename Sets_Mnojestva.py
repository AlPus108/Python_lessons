...
# В set имеет изменяемый тип даннх, то есть в него пожно добавлять элементы и т.д.
...
# Возникает необходимость проверить наличие конкретного элемента в мнжестве.
