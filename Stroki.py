...
# Второй более удобный способ форматирование строк - через декоратор f (появился в Pythin.3)
...
# Часто требуется для парсинга строк разбиение строки на подстроки. Для этого создали сетод split()
