...
# Конструкция range(start, stop, step)  - не включительно stop
# start - число с которого начинаем,
# stop - число, которым заканчиваем, но оно не включается в интервал
# step - шаг, через какой интервал будут браться числа

# for i in range(0, 10, 1):  # здесь будем брать все числа от 0 до 10(исключительно). Получим 0.....9
#     print(i)
# 0
# 1
# 2
