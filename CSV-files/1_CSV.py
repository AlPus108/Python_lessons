...
# Так же вносят некоторую сложность знаки ковычек, которые окружают поле и т.д.
...
# Помещаем в него информацию о машинах.

# Открываем файл и считываем его с помощью метода read()
...
# в свой объект, называемй dataframe. Pandas предоставляет огромный арсенал инструментов для работы с файлами.
