...
class TestDice:
    ...
    # Сделаем его атрибутом класса TestDice, то есть пишем через self. Теперь во всем коде мы можем к нему
    ...
    def test_init(self):
        ...
        assert self.dice_game.throw_num == 2  # проверяем, что throw_num действительно == 2
